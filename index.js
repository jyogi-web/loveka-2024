...
const { Client, middleware } = require('@line/bot-sdk'); // LINE Messaging API SDKをインポート
const ejs = require('ejs'); // EJSテンプレートエンジンをインポート
const path = require('path'); // パス操作用のモジュールをインポート
